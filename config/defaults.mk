...
ifeq ($(MFEM_USE_NVECTOR_CUDA)$(MFEM_USE_NVECTOR_OCCA),YESYES)
$(error MFEM_USE_NVECTOR_CUDA and MFEM_USE_NVECTOR_OCCA are mutually exclusive)
endif

ifeq ($(MFEM_USE_NVECTOR_CUDA),YES)
   ifndef CUDA_DIR

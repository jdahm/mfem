...
MFEM_DEFINES = MFEM_VERSION MFEM_USE_MPI MFEM_USE_METIS_5 MFEM_DEBUG\
 ...
 MFEM_USE_STRUMPACK MFEM_USE_GNUTLS MFEM_USE_NETCDF MFEM_USE_PETSC MFEM_USE_MPFR MFEM_USE_SIDRE\
 MFEM_USE_OCCA MFEM_USE_ACROTENSOR\
 MFEM_USE_NVECTOR_OPENMP MFEM_USE_NVECTOR_CUDA MFEM_USE_NVECTOR_OCCA
...
status info:
	...
	$(info MFEM_USE_SUNDIALS_CUDA = $(MFEM_USE_SUNDIALS_CUDA))

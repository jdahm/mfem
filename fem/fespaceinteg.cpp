...
void FESDiffusionIntegrator::MultSeg_Host(const Vector &V, Vector &U)
{
   const int dim = 1;
...
void FESDiffusionIntegrator::MultQuad_Host(const Vector &V, Vector &U)
{
   const int dim = 2;
   const int terms = dim*(dim+1)/2;
   const int vdim = fes->GetVDim();
...
void FESDiffusionIntegrator::MultHex_Host(const Vector &V, Vector &U)
{
   const int dim = 3;
   const int terms = dim*(dim+1)/2;
   const int vdim = fes->GetVDim();
...
void FESMassIntegrator::MultSeg_Host(const Vector &V, Vector &U)
{
   const int dofs1d = shape1d.Height();
   const int quads1d = shape1d.Width();
...
void FESMassIntegrator::MultQuad_Host(const Vector &V, Vector &U)
{
   const int dofs1d = shape1d.Height();
   const int quads1d = shape1d.Width();
   const int msize = std::max(dofs1d, quads1d);
...
void FESMassIntegrator::MultHex_Host(const Vector &V, Vector &U)
{
   const int dofs1d = shape1d.Height();
   const int quads1d = shape1d.Width();
   const int msize = std::max(dofs1d, quads1d);
